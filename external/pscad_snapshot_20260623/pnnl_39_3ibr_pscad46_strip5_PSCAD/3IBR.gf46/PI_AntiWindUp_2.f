...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_2Dyn(In, Out, frz, Rst, Kp, Ti, Kaw,     &
     &   MaxOut, MinOut)
...
!  Hard_Limit
      ...
      ELSE
        ...
        IF (STORL(NSTORL) .EQV. .FALSE.) THEN
          CALL EMTDC_WARN(ICALL_NO,1293917410,1,"Lower limit is more tha&
...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE PI_AntiWindUp_2Out_Begin()
