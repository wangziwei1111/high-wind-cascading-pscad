...
#------------------------------------------------------------------------------
# Project '3IBR' make using the 'GFortran 4.2.1' compiler.
#------------------------------------------------------------------------------
...
FC_Objects = \
 ...
 Type3_WTG_Avg.$(FC_Suffix) \
 Synchronization.$(FC_Suffix) \
 WindTurbine_MechModel.$(FC_Suffix) \
 PI_AntiWindUp_2.$(FC_Suffix) \
 DFIG_Converters_Avg.$(FC_Suffix) \
 Filter.$(FC_Suffix) \
 Grid_side_Controls.$(FC_Suffix) \
 Rotor_side_Controls.$(FC_Suffix) \
 PI_AntiWindUp.$(FC_Suffix) \
 Crowbar_prot.$(FC_Suffix) \
 Chopper.$(FC_Suffix) \
 ConvBridge_Avg.$(FC_Suffix)
